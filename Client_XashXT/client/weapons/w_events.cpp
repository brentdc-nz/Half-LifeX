...
*
****/
//#include "../hud.h" //MARTY FIXME - DIR Stucture
//#include "../utils.h"
#include "..\hud.h"
#include "..\utils.h"
...
#include "..\..\game_shared\pm_materials.h"
#include "w_events.h"
...
int cl_lw=0; //no prediction in xash?
...
void EV_Crowbar( event_args_t *args ) //Nicknekit: no swing animation? Set cl_lw cvar to "0"
{
	int idx;
	vec3_t origin;
	vec3_t angles;
...
void EV_FireGauss( event_args_t *args )
{
	...
	vec3_t up, right, forward, vec3_origin;
...
void EV_EgonFire( event_args_t *args )
{
	...
	if ( iStartup == 1 && EV_IsLocal( idx ) && !pBeam && !pBeam2 && cl_lw) 
	{
