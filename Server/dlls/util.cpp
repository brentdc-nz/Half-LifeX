...
void CSave :: WriteFunction( datamap_t *pRootMap, const char *pname, inputfunc_t **data, int count ) // MARTY - Updated
{
...
int CRestore::ReadField( datamap_t *pMap, void *pBaseData, TYPEDESCRIPTION *pFields, int fieldCount, int startField, int size, char *pName, void *pData )
{
...
{
	return ReadFields( NULL, pname, pev, gEntvarsDescription, ENTVARS_COUNT );
}


int CRestore::ReadFields( datamap_t *pMap, const char *pname, void *pBaseData, TYPEDESCRIPTION *pFields, int fieldCount )
{
