...
BEGIN_DATADESC( CFrictionModifier )
	...
	DEFINE_ENTITYFUNC( ChangeFriction )
...
BEGIN_DATADESC( CChangeLevel )
	...
	DEFINE_ENTITYFUNC( TouchChangeLevel ) 
...
BEGIN_DATADESC( CTriggerGravity )
	...
	DEFINE_ENTITYFUNC( GravityTouch )
