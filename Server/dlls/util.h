...
extern const char	*UTIL_FunctionToName( datamap_t *pMap, inputfunc_t *function ); // MARTY
extern inputfunc_t *UTIL_FunctionFromName( datamap_t *pMap, const char *pName ); // MARTY
