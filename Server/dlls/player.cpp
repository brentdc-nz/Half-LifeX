...
int CBasePlayer::Save( CSave &save )
{
	...
	return save.WriteFields( "PLAYER", this, GetDataDescMap(), m_playerSaveData, ARRAYSIZE(m_playerSaveData) );
}
...
int CBasePlayer::Restore( CRestore &restore )
{
	...
	int status = restore.ReadFields( GetDataDescMap(), "PLAYER", this, m_playerSaveData, ARRAYSIZE(m_playerSaveData) );
