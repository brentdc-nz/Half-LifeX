...
#ifdef _XBOX //MARTY
cvar_t	*cl_invert_look;
cvar_t	*cl_rthumb_sensitivity;
#endif
...
{	
	...
	if( active )
	{
		...
		/*if( !CL_IsDead( ))*/ IN_Move( frametime, cmd ); //MARTY FIXME - Disabled until controls are sorted
	}
...
#ifdef _XBOX
	cl_invert_look	= CVAR_REGISTER ( "cl_invert_look", "0", FCVAR_ARCHIVE );
	cl_rthumb_sensitivity = CVAR_REGISTER ( "cl_rthumb_sensitivity", "3.5", FCVAR_ARCHIVE );
#endif
