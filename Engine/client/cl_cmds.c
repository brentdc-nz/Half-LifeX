...
{
#ifdef _AVIPLAYBACK // MARTY - Intro Valve logo video playback, disabled
                    //         as we don't have a decoder on Xbox atm
	string	path;
...
void CL_DeleteDemo_f( void )
{
	...
	// delete demo
	FS_Delete( va( "demos\\%s.dem", Cmd_Argv( 1 ))); // MARTY - Fixed slashes
}
