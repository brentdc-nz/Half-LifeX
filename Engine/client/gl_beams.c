...
//			/*p*/glNormal3fv( vAveNormal ); // MARTY TODO - Need to implement, seems to work ok without tho
...
//			/*p*/glNormal3fv( vAveNormal ); // MARTY TODO - Need to implement, seems to work ok without tho
 		...
 		if( segs_drawn == total_segs )
		{
			...
			/*p*/glTexCoord2f( 0.0f, curSeg.texcoord );
			TriBrightness( brightness );
//			/*p*/glNormal3fv( vLastNormal ); // MARTY TODO - Need to implement, seems to work ok without tho
			/*p*/glVertex3fv( vPoint1 );
...
void CL_DrawBeams( int fTrans )
{
	...
	/*p*/glDepthMask( fTrans ? GL_FALSE : GL_TRUE );
