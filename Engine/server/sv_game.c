...
void StaticGiveFnptrsToDll(	enginefuncs_t* pengfuncsFromEngine, globalvars_t *pGlobals );
int StaticGetEntityAPI( DLL_FUNCTIONS *pFunctionTable, int interfaceVersion );
int StaticGetEntityAPI2( DLL_FUNCTIONS *pFunctionTable, int *interfaceVersion );
...
edict_t* SV_AllocPrivateData( edict_t *ent, string_t className )
{
	...
	SpawnEdict( &ent->v );
#else // Spawn using static linked function
	if(!Q_strcmp( pszClassName, "worldspawn" ))
	{
		worldspawn(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "bodyque" ))
	{
		bodyque(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "info_player_start" ))
	{
		info_player_start(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "item_suit" ))
	{
		item_suit(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "item_battery" ))
	{
		item_battery(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "item_antidote" ))
	{
		item_antidote(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "item_security" ))
	{
		item_security(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "item_longjump" ))
	{
		item_longjump(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_shotgun" ))
	{
		weapon_shotgun(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "ammo_buckshot" ))
	{
		ammo_buckshot(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_crowbar" ))
	{
		weapon_crowbar(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_9mmhandgun" ))
	{
		weapon_9mmhandgun(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "ammo_9mmclip" ))
	{
		ammo_9mmclip(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_9mmAR" ))
	{
		weapon_9mmAR(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "ammo_9mmAR" ))
	{
		ammo_9mmAR(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "ammo_ARgrenades" ))
	{
		ammo_ARgrenades(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_357" ))
	{
		weapon_357(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "ammo_357" ))
	{
		ammo_357(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_gauss" ))
	{
		weapon_gauss(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "ammo_gaussclip" ))
	{
		ammo_gaussclip(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_rpg" ))
	{
		weapon_rpg(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "rpg_rocket" ))
	{
		rpg_rocket(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "laser_spot" ))
	{
		laser_spot(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "ammo_rpgclip" ))
	{
		ammo_rpgclip(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_crossbow" ))
	{
		weapon_crossbow(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "crossbow_bolt" ))
	{
		crossbow_bolt(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "ammo_crossbow" ))
	{
		ammo_crossbow(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_egon" ))
	{
		weapon_egon(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_tripmine" ))
	{
		weapon_tripmine(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_tripmine" ))
	{
		monster_tripmine(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_satchel" ))
	{
		weapon_satchel(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_satchel" ))
	{
		monster_satchel(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_handgrenade" ))
	{
		weapon_handgrenade(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_snark" ))
	{
		weapon_snark(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_snark" ))
	{
		monster_snark(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "hornet" ))
	{
		hornet(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_hornetgun" ))
	{
		weapon_hornetgun(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "light" ))
	{
		light(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "info_landmark" ))
	{
		info_landmark(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_wall" ))
	{
		func_wall(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_door" ))
	{
		func_door(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_rotating" ))
	{
		func_rotating(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_message" ))
	{
		env_message(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "info_node" ))
	{
		info_node(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_breakable" ))
	{
		func_breakable(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_sentry" ))
	{
		monster_sentry(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_multiple" ))
	{
		trigger_multiple(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_beam" ))
	{
		env_beam(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "info_target" ))
	{
		info_target(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_ladder" ))
	{
		func_ladder(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_changelevel" ))
	{
		trigger_changelevel(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_button" ))
	{
		func_button(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_scientist_dead" ))
	{
		monster_scientist_dead(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_barney_dead" ))
	{
		monster_barney_dead(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_spark" ))
	{
		env_spark(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_render" ))
	{
		env_render(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "infodecal" ))
	{
		infodecal(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_hurt" ))
	{
		trigger_hurt(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "ambient_generic" ))
	{
		ambient_generic(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "multi_manager" ))
	{
		multi_manager(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_pushable" ))
	{
		func_pushable(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_relay" ))
	{
		trigger_relay(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_glow" ))
	{
		env_glow(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_scientist" ))
	{
		monster_scientist(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "path_track" ))
	{
		path_track(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "light_spot" ))
	{
		light_spot(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_sound" ))
	{
		env_sound(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_sitting_scientist" ))
	{
		monster_sitting_scientist(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_barney" ))
	{
		monster_barney(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_once" ))
	{
		trigger_once(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "scripted_sequence" ))
	{
		scripted_sequence(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_furniture" ))
	{
		monster_furniture(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_gman" ))
	{
		monster_gman(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_auto" ))
	{
		trigger_auto(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_door_rotating" ))
	{
		func_door_rotating(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "scripted_sentence" ))
	{
		scripted_sentence(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_healthcharger" ))
	{
		func_healthcharger(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_sprite" ))
	{
		env_sprite(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_illusionary" ))
	{
		func_illusionary(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_tracktrain" ))
	{
		func_tracktrain(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_generic" ))
	{
		monster_generic(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_fade" ))
	{
		env_fade(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_headcrab" ))
	{
		monster_headcrab(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_friction" ))
	{
		func_friction(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_alien_slave" ))
	{
		monster_alien_slave(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_gargantua" ))
	{
		monster_gargantua(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_bubbles" ))
	{
		env_bubbles(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_leech" ))
	{
		monster_leech(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_wall_toggle" ))
	{
		func_wall_toggle(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_human_grunt" ))
	{
		monster_human_grunt(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_traincontrols" ))
	{
		func_traincontrols(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_zombie" ))
	{
		monster_zombie(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_hgrunt_dead" ))
	{
		monster_hgrunt_dead(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "path_corner" ))
	{
		path_corner(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_train" ))
	{
		func_train(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_platrot" ))
	{
		func_platrot(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_shake" ))
	{
		env_shake(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_autosave" ))
	{
		trigger_autosave(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_cdaudio" ))
	{
		trigger_cdaudio(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "test_effect" ))
	{
		test_effect(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_monsterjump" ))
	{
		trigger_monsterjump(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_trackchange" ))
	{
		func_trackchange(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_rot_button" ))
	{
		func_rot_button(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_laser" ))
	{
		env_laser(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_monsterclip" ))
	{
		func_monsterclip(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_explosion" ))
	{
		env_explosion(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "multisource" ))
	{
		multisource(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_recharge" ))
	{
		func_recharge(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monstermaker" ))
	{
		monstermaker(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_cockroach" ))
	{
		monster_cockroach(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "item_healthkit" ))
	{
		item_healthkit(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "target_cdaudio" ))
	{
		target_cdaudio(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_pendulum" ))
	{
		func_pendulum(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "light_environment" ))
	{
		light_environment(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "player" ))
	{
		player(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "speaker" ))
	{
		speaker(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "ammo_glockclip" ))
	{
		ammo_glockclip(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_mp5" ))
	{
		weapon_mp5(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "gibshooter" ))
	{
		gibshooter(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_shooter" ))
	{
		env_shooter(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_beverage" ))
	{
		env_beverage(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_trackautochange" ))
	{
		func_trackautochange(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_push" ))
	{
		trigger_push(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "cycler" ))
	{
		cycler(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_transition" ))
	{
		trigger_transition(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_global" ))
	{
		env_global(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_tankcontrols" ))
	{
		func_tankcontrols(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_tank" ))
	{
		func_tank(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "spark_shower" ))
	{
		spark_shower(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_smoker" ))
	{
		env_smoker(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "world_items" ))
	{
		world_items(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_water" ))
	{
		func_water(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_conveyor" ))
	{
		func_conveyor(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_bullchicken" ))
	{
		monster_bullchicken(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "info_teleport_destination" ))
	{
		info_teleport_destination(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_teleport" ))
	{
		trigger_teleport(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_alien_grunt" ))
	{
		monster_alien_grunt(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "item_sodacan" ))
	{
		item_sodacan(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "env_funnel" ))
	{
		env_funnel(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_alien_controller" ))
	{
		monster_alien_controller(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_camera" ))
	{
		trigger_camera(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_flyer_flock" ))
	{
		monster_flyer_flock(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "player_weaponstrip" ))
	{
		player_weaponstrip(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "controller_energy_ball" ))
	{
		controller_energy_ball(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "controller_head_ball" ))
	{
		controller_head_ball(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_tentacle" ))
	{
		monster_tentacle(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_barnacle" ))
	{
		monster_barnacle(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "aiscripted_sequence" ))
	{
		aiscripted_sequence(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "xen_plantlight" ))
	{
		xen_plantlight(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "xen_tree" ))
	{
		xen_tree(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "xen_spore_medium" ))
	{
		xen_spore_medium(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "xen_spore_small" ))
	{
		xen_spore_small(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "xen_spore_large" ))
	{
		xen_spore_large(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_gravity" ))
	{
		trigger_gravity(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "info_bigmomma" ))
	{
		info_bigmomma(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_bigmomma" ))
	{
		monster_bigmomma(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_hevsuit_dead" ))
	{
		monster_hevsuit_dead(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weaponbox" ))
	{
		weaponbox(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "player_loadsaved" ))
	{
		player_loadsaved(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_babycrab" ))
	{
		monster_babycrab(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_houndeye" ))
	{
		monster_houndeye(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "beam" ))
	{
		beam(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "weapon_glock" ))
	{
		weapon_glock(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_miniturret" ))
	{
		monster_miniturret(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "fireanddie" ))
	{
		fireanddie(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_rat" ))
	{
		monster_rat(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "momentary_rot_button" ))
	{
		momentary_rot_button(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "momentary_door" ))
	{
		momentary_door(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "info_player_deathmatch" ))
	{
		info_player_deathmatch(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "info_intermission" ))
	{
		info_intermission(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_tankrocket" ))
	{
		func_tankrocket(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_guntarget" ))
	{
		func_guntarget(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "ammo_mp5clip" ))
	{
		ammo_mp5clip(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "ammo_mp5grenades" ))
	{
		ammo_mp5grenades(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "trigger_endsection" ))
	{
		trigger_endsection(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_mortar_field" ))
	{
		func_mortar_field(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_osprey" ))
	{
		monster_osprey(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_mortar" ))
	{
		monster_mortar(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "grenade" ))
	{
		grenade(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "cycler_sprite" ))
	{
		cycler_sprite(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_ichthyosaur" ))
	{
		monster_ichthyosaur(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_human_assassin" ))
	{
		monster_human_assassin(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_apache" ))
	{
		monster_apache(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "hvr_rocket" ))
	{
		hvr_rocket(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "cycler_wreckage" ))
	{
		cycler_wreckage(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_tankmortar" ))
	{
		func_tankmortar(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_turret" ))
	{
		monster_turret(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "func_tanklaser" ))
	{
		func_tanklaser(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "info_node_air" ))
	{
		info_node_air(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "xen_hair" ))
	{
		xen_hair(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "xen_ttrigger" ))
	{
		xen_ttrigger(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "xen_hull" ))
	{
		xen_hull(&ent->v);
	}	
	else if(!Q_strcmp( pszClassName, "env_blood" ))
	{
		env_blood(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "DelayedUse" ))
	{
		DelayedUse(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "monster_nihilanth" ))
	{
		monster_nihilanth(&ent->v);
	}
	else if(!Q_strcmp( pszClassName, "nihilanth_energy_ball" ))
	{
		nihilanth_energy_ball(&ent->v);
	}
	else
	{
		if( svgame.physFuncs.SV_CreateEntity && svgame.physFuncs.SV_CreateEntity( ent, pszClassName ) != -1 )
...
{
#if defined(_XBOX) && defined(_HARDLINKED) // MARTY - Unused, done in the server lib on Xbox
	return (dword)NULL;
#else
...
#ifdef _HARDLINKED
// HACK: To stop progs been unloaded
// FIXME: Set breakpoints to find why it's been
//        unloaded but was unable to find why, need
//        to spend more time and fix this properly
static int iProgsLoaded = 0;
#endif
...
qboolean SV_LoadProgs( const char *name )
{
...
#ifdef _HARDLINKED
	// HACK: As above need to fix properly
	if(iProgsLoaded)
		return true;
#endif
...
#else
	StaticGiveFnptrsToDll( &gpEngfuncs, svgame.globals );
#endif

	// get extended callbacks
#ifndef _HARDLINKED // MARTY TODO - Ok for now. GetNewDLLFunctions does not exist in stock hl.dll
	if( GiveNewDllFuncs )
	{
	...
	if( !StaticGetEntityAPI( &svgame.dllFuncs, version )) // MARTY
	{
#ifndef _HARDLINKED
		if( !StaticGetEntityAPI2 )
		{
			COM_FreeLibrary( svgame.hInstance );
...
#endif			
		if( !StaticGetEntityAPI2( &svgame.dllFuncs, &version )) //MARTY
		{
			COM_FreeLibrary( svgame.hInstance );
			Con_Printf("SV_LoadProgs: interface version %i should be %i\n", INTERFACE_VERSION, version );
			svgame.hInstance = NULL;
			return false;
		}
