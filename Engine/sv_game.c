...
#ifdef _TEMPSAVEHACK //MARTY - Very nasty temp kinda fix, save/load still partly broken
...
{
#ifdef _TEMPSAVEHACK //MARTY
	return TSH_FunctionFromName( pName );
#else
...
{
#ifdef _TEMPSAVEHACK //MARTY
	return TSH_NameForFunction( function );
#else
