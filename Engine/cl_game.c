...
{
	/*p*/glEnable( GL_BLEND );
	/*p*/glBlendFunc( blendsrc, blenddst ); // g-cont. are params is valid?
...
void pfnFillRGBABlend( int x, int y, int width, int height, int r, int g, int b, int a )
{
	...
	/*p*/glEnable( GL_BLEND );
	/*p*/glDisable( GL_ALPHA_TEST );
	/*p*/glBlendFunc( GL_ONE_MINUS_SRC_ALPHA, GL_ONE );
	/*p*/glTexEnvi( GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_MODULATE );
...
void TriBegin( int mode )
{
	switch( mode )
	{
//	case TRI_POINTS: //MARTY FIXME WIP
//		mode = GL_POINTS;
//		break;
	case TRI_TRIANGLES:
		mode = GL_TRIANGLES;
...
void TriColor4f( float r, float g, float b, float a )
{
	...
	/*p*/glColor4ub( clgame.ds.triColor[0], clgame.ds.triColor[1], clgame.ds.triColor[2], clgame.ds.triColor[3] );
}
...
void TriBrightness( float brightness )
{
	...
	///*p*/glColor3ub( rgba[0], rgba[1], rgba[2] ); //MARTY FIXME WIP
}
