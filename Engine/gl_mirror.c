...
{
#ifdef _MIRRORS // MARTY - Mirrors are not used in stock Half-Life
...
int R_AllocateMirrorTexture( void )
{
	...
	/*p*/glCopyTexImage2D( GL_TEXTURE_2D, 0, GL_RGB, RI.viewport[0], RI.viewport[1], RI.viewport[2], RI.viewport[3], 0 );
