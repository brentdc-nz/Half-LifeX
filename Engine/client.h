...
#ifdef _XBOX //MARTY - Needed for gamepad input call
#include "keydefs.h"
#endif
...
typedef struct
{
	...
	// predicting stuff
	vec3_t		predicted_origin;		// generated from CL_PredictMovement
...
//
// cl_video.c //MARTY FIXME WIP - Intro Valve logo video playback functions
//
