...
====================
*/
void CL_PlayVideo_f( void ) //MARTY FIXME WIP - Intro Valve logo video playback
{
/*	string	path;
...
================== 
*/
void CL_EnvShot_f( void ) //MARTY FIXME WIP
{
	if( Cmd_Argc() < 2 )
	{
...
================== 
*/
void CL_SkyShot_f( void ) //MARTY FIXME WIP
{
	if( Cmd_Argc() < 2 )
	{
...
================== 
*/ 
void CL_LevelShot_f( void ) //MARTY FIXME WIP
{
//	size_t	ft1, ft2;
...
void CL_SaveShot_f( void )
{
	...
	Q_sprintf( cls.shotname, "save\\%s.bmp", Cmd_Argv( 1 ));  //MARTY - Fixed Slashes
...
void CL_DemoShot_f( void ) //MARTY FIXME WIP
{
	...
	Q_sprintf( cls.shotname, "demos\\%s.bmp", Cmd_Argv( 1 ));  //MARTY - Fixed slashes
...
void CL_DeleteDemo_f( void )
{
	...
	FS_Delete( va( "demos\\%s.dem", Cmd_Argv( 1 ))); //MARTY - Fixes Slashes
	FS_Delete( va( "demos\\%s.bmp", Cmd_Argv( 1 ))); //MARTY
}
