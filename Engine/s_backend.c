...
#ifdef _SDL_SOUND //MARTY - Using SDL for now, may convert to DirectSound in future.
#include "sdl.h"
#endif
...
//	Con_Printf("Using SDL audio driver: %s @ %d Hz\n", SDL_GetCurrentAudioDriver(), obtained.freq); //MARTY
	Con_Printf("Using XBox SDL audio driver @ %d Hz\n", obtained.freq); //MARTY
...
{
	Msg( "Audio: SDL(Driver: XBox)\n"/*, SDL_GetCurrentAudioDriver()*/ ); //MARTY
}
...
*/
#ifndef _XBOX //MARTY
void S_Activate( qboolean active, void *hInst ) //MARTY - Not used on XBox
{
