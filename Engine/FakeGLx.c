...
====================================================================================================================================
	...
	- define _USEFAKEGL somewhere in your code; I suggest either at the top of quakedef.h or glquake.h
	...
	- depending on your code you may also need to make certain other changes; see the examples given in sbar.c and
	  gl_screen.h for an idea of the kind of thing you might need (just search for #ifdef _USEFAKEGL).
...
void glTexSubImage2D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels)
{
	...
	if (format == 1 || format == GL_LUMINANCE || format == GL_LUMINANCE8 ) //MARTY
		...
		Sys_Error ("D3D_FillTextureLevel: illegal format");
...
/*
	...
	d3d_PresentParams.Flags =  D3DPRESENTFLAG_PROGRESSIVE; //MARTY
}
...
void glReadPixels (GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid *pixels)
{
	...
	hr = IDirect3DDevice8_CreateImageSurface (d3d_Device, desc.Width, desc.Height, /*D3DFMT_R8G8B8*/D3DFMT_X8R8G8B8, &locksurf); //CHECKME: Linear/Compressed format ?
