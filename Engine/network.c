...
#ifdef _XBOX_USING_WINSOCK //MARTY
...
{
#ifdef _XBOX_USING_WINSOCK //MARTY - No multiplayer yet
	uint 		ret;
	struct sockaddr	addr;
	int		err, addr_len;
	int		net_socket;
	int		protocol;
#endif //_XBOX_USING_WINSOCK //MARTY
...
#ifdef _XBOX_USING_WINSOCK //MARTY FIXME WIP - Return a defualt string!
		else
		{
...
#ifdef _XBOX_USING_WINSOCK //MARTY  - Not required for local play.
