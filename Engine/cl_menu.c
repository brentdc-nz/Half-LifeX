...
void UI_SetActiveMenu( qboolean fActive ) //MARTY FIXME WIP - Logo video
{
	//movie_state_t	*cin_state; //MARTY FIXME WIP
...
static void UI_DrawLogo( const char *filename, float x, float y, float width, float height ) //MARTY FIXME WIP
{
