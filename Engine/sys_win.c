...
#ifdef _XBOX //MARTY - Needed for gamepad call
#include "keydefs.h"
#include "client.h"
#endif
...
{
	char	*data = NULL;
#ifndef _XBOX //MARTY - Not required
	char	*cliptext;
...
#ifndef _XBOX //MARTY - Let's just use default "player" on XBox
...
void Sys_Error( const char *error, ... )
{
	...
	OutputDebugString(error); //MARTY FIXME WIP - To be removed in future
...
#ifndef _DEBUG //MARTY FIXME WIP - Remove latter
	if( host.developer < level ) return; //MARTY FIXME WIP - We need all errors atm to help debug
#endif
