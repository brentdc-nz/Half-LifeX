...
#ifndef _XBOX // Not needed on Xbox obviously
...
void Host_InitCommon( const char *hostname, qboolean bChangeGame )
{
...
#ifdef _XBOX // 128MB Xboxes needs this to fucntion correctly, taken from XBMC
	...
	*out = '\0'; // write terminator
	...
	if( host.type == HOST_DEDICATED )
	{
#ifndef _XBOX // We don't care about dedicated server on Xbox
...
void EXPORT Host_Shutdown( void )
{
	...
	NET_Shutdown();
	Host_FreeCommon();
#ifndef _XBOX // MARTY - No startup console on Xbox
	Con_DestroyConsole();
#endif
