...
//static wavdata_t		cin_audio; //MARTY FIXME WIP
//static movie_state_t	*cin_state; //MARTY FIXME WIP
...
==================
*//*
qboolean SCR_PlayCinematic( const char *arg )  //MARTY FIXME WIP
{
	string		path;
	const char	*fullpath;
...
long SCR_GetAudioChunk( char *rawdata, long length )  //MARTY FIXME WIP
{
	int	r;
...
wavdata_t *SCR_GetMovieInfo( void )  //MARTY FIXME WIP
{
	if( AVI_IsActive( cin_state ))
		return &cin_audio;
	return NULL;
...
==================
*/
void SCR_StopCinematic( void ) //MARTY FIXME WIP - Intro Valve logo playback function
{
	if( cls.state != ca_cinematic )
		return;
...
==================
*/
void SCR_InitCinematic( void )  //MARTY FIXME WIP
{
/*	AVI_Initailize ();
...
==================
*/
void SCR_FreeCinematic( void )  //MARTY FIXME WIP
{
